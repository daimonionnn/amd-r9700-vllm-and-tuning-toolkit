...
| [r9700-oc-uv-findings.md](r9700-oc-uv-findings.md) | Overclock / undervolt results. On the current ROCm 7.14 / amdgpu DKMS 6.19.4 stack, memory-clock OD and core undervolt are no-ops or slightly harmful for inference; only the fan curve and a couple of boot args matter. Community reference settings included. |
