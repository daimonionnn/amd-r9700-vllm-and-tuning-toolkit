...
# ================================================================
# run_vllm_aiter_0202_pp2.sh
#
# Helper around docker compose profile:
#   vllm/docker-compose.aiter-0202.pp2-r9700.yml
#
# Defaults target 2x R9700 with the Austin-style unified-attention setup.
# ================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
COMPOSE_FILE="${SCRIPT_DIR}/docker-compose.aiter-0202.pp2-r9700.yml"
